...
export default function App() {
  ...
  }, [handleSave, handleActivate, handleSyntaxCheck, toggleSidebar, toggleBottomPanel]);
      ...
      <div className="flex flex-1 overflow-hidden">
        <Sidebar>
          {sidebarPanel === 'explorer' ? (
            <ExplorerPanel onOpenObject={handleOpenObject} />
          ) : (
            <SearchPanel onOpenObject={handleOpenObject} />
          )}
        </Sidebar>
